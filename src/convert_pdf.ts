...
import { PDFLoadingTask, PDFDocumentProxy, TextContentItem } from 'pdfjs-dist' // @ts-ignore
...
export async function convertTask(taskFile: string, outputFile: string): Promise<void> {
