...
function convertTask(taskFile, outputFile) {
    const mdText = (0, util_1.readFileSyncStrippingBom)(taskFile);
...
function renderMarkdown(text, fullHtml) {
    ...
    const metadata = (_a = env.taskMetadata) !== null && _a !== void 0 ? _a : (0, util_1.defaultTaskMetadata)();
    const htmlStart = '' +
        `<!DOCTYPE html>
     <html lang="en">
       <head>
...
function defaultPluginOptions() {
    return {
        langCode: (0, codes_1.defaultLanguageCode)(),
